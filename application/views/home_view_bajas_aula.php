			...
			<table class="table table-hover">
				...
				<tbody>
					<?php for($i=0;$i<count($aulas);$i++){
						?>
						<tr>
							<th scope='row'><?php echo $aulas[$i]['id_aula'] ?> </th>
							<th> <?php echo $aulas[$i]['nombre'] ?> </th>
							<?php $id = $aulas[$i]['id_aula']; ?>
							<th><?php echo "<a href='http://localhost:8080/cetis/index.php/home/deleteAula/".$id."' class='btn btn-danger'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></a>"?></th>
						</tr>
				<?php } ?>
				</tbody>
			</table>
