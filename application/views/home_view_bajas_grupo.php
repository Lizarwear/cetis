			...
			<table class="table table-hover">
				...
				<tbody>
					<?php for($i=0;$i<count($grupos);$i++){
						?>
						<tr>
							<th scope='row'><?php echo $grupos[$i]['id_grupo'] ?> </th>
							<th> <?php echo $grupos[$i]['nombre'] ?> </th>
							<?php $id = $grupos[$i]['id_grupo']; ?>
							<th><?php echo "<a href='http://localhost:8080/cetis/index.php/home/deleteGrupo/".$id."' class='btn btn-danger'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></a>"?></th>
						</tr>
				<?php } ?>
				</tbody>
			</table>
